...
ns.event["EquipFirstEpic"] = _event

-- General info
_event.name = "EquipFirstEpic"
_event.type = "Achievement"
_event.subtype = "GeneralAchievement"
_event.title = "Equip your first epic item."
_event.icon_path = ""
_event.pts = 3
_event.description = "|cffddddddEquip your first |r|cffa335eeepic|r |cffdddddditem|r."
