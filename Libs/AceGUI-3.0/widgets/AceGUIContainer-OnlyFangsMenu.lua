...
Frame Container
-------------------------------------------------------------------------------]]
local Type, Version = "OnlyFangsMenu", 28
...
local function Constructor()
	...
	statustext:SetFont(OnlyFangs_L.menu_font, 16)
